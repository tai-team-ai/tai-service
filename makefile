...
build-and-run-docker-api:
	...
	sudo docker run --network host -e MESSAGE_ARCHIVE_BUCKET_NAME="tai-service-message-archive-dev" -e OPENAI_API_KEY_SECRET_NAME="dev/tai_service/openai/api_key" -e SEARCH_SERVICE_API_URL="http://tai-s-taise-4mq43vlacxyh-2086925889.us-east-1.elb.amazonaws.com" -e AWS_DEFAULT_REGION="us-east-1" test-container
